...
class Electric():
    ...
    """
    Schematic cross-section of a hollow metallic prism with a solid,metallic inner 
    conductor. The prism and inner conductor are ppresumed to be infinite in extent
    along z. The inner conductor is held at V-1 and the walls of the prism at V=0
    """ 
