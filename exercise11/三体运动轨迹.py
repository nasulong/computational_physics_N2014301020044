# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 12:07:18 2016
...
class three_body():
    """
    Simulation of a solar system with two planets,Earth and Jupiter
    """
    ...
    def show_result(self):
        ...
        pl.ylim(-6,6)
        pl.grid(True)
        pl.title('3—body simulation  Earth plus Jupiter,MJ')
        pl.show()
...
v=three_body(I_e[0],I_e[1],I_e[2],I_e[3],I_j[0],I_j[1],I_j[2],I_j[3])
v.calculate()
v.show_result()
