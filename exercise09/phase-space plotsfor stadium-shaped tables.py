# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 17:59:49 2016
...
class billiard_on_a_square_table():
    """phase-space plots for stadium billiard
    """
    def __init__(self,time_step=0.01,x0=0.2,y0=0,vx0=1,vy0=0.6,steps=400000,α=0.01):
        self.x=[x0]
        self.y=[y0]
        self.vx=[vx0]
        self.vy=[vy0]
    ...
    def show_result(self):
        ...
        pl.xlim(-1,1)
        pl.ylim(-1,1)
        pl.title("phase-space plots for stadium billiard:$\\alpha=0.01$")
        pl.show()
